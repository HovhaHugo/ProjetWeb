<div class="container">
    <form action="/ProjetWeb/index.php?uc=inscription&action=valid_inscription" method="post">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="firstname" class="form-control" placeholder="Smith">
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="sexe" class="form-control" id="sexe" placeholder="Homme/Femme/Autre">
        </div>
        <div class="form-group col-md-4">
            <label for="phone">Numéro de téléphone</label>
            <input type="text" name="phone" class="form-control" id="phone" placeholder="XXXXXXXXXX">
        </div>
        <div class="form-group col-md-4">
